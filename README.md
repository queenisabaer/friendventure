...
- **Displaying an Overview of FriendVentures from followed Users**<br> 
As a user, you can view an overview of all FriendVentures created by the users you follow. This page can be reached through the navigation bar by selecting  *Explore* in the FriendVentures dropdown menu.  This page showcases FriendVentures created by the followed users, presented in a card format similar to the homepage overview. Each card includes essential details such as the title, description, date, time, location, category, creator information (with a link to the creator's profile), and counts of participants, bookmarks, and comments, as well as the last updated timestamp.
The page supports infinite scroll functionality: after scrolling through the initial set of entries, more FriendVentures will be loaded automatically, accompanied by a spinner indicating the loading process. On mobile devices, the FriendVentures are displayed with the most active profiles shown prominently above them, while on desktop, these profiles are displayed alongside the FriendVentures.
...
| Access followees FriendVentures - navigation bar | Click on *Explore* in the dropdown menu *FriendVentures* in the navigation bar | The user should be redirected to the overview page displaying all FriendVentures of users they follow | Pass |
| Followees FriendVenture page - display elements | Navigate to the FriendVentures overview page of users you follow | Each FriendVenture card should display the title, description, date, time, location, category, creator information, participant count, bookmark count, comment count, and last updated timestamp | Pass |
| Followees FriendVenture page - Creator Link | Click on the creator's name in a FriendVenture card on theoverview FriendVentures page of users you follow | The user should be redirected to the profile page of the creator | Pass |
| Followees FriendVenture page (infinite scroll)| Scroll down the FriendVentures overview page of users you follow after 10 FriendVentures are loaded | The next set of FriendVentures should be automatically loaded, and a spinner should be briefly displayed while loading | Pass |
| Followees FriendVentures page (mobile view) - Most active profiles placement | Access the FriendVentures overview page of users you follow (*FriendVentures* > *Explore*) on a mobile device | The most active profiles should be displayed above the FriendVentures | Pass |
| Followees FriendVentures page (desktop view) - Most Active Profiles Placement | Access the FriendVentures overview page of users you follow on a desktop device | The most active profiles should be displayed next to the FriendVentures | Pass |
